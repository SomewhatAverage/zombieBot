exports.helpCMD = (
  ...
  "- **<p *perk_name*** -> informations about the written perk\n" +
  "- **<perks** -> everything about perks + list\n" +
  "- **<r *room_name*** -> informations about the written room\n" +
  "- **<rooms** -> everything about rooms + list\n" +
  "- **<switch** -> everything about power switch\n" +
  "- **<w *weapon_name*** -> informations about the written weapon\n" +
  ...
  "- **<set name *set_name* (you can use spaces)**\n" +
  ...
  "- **<report text *describe problem here*** -> report text errors like a misspelling or an emoji which does not work, etc\n"
);
